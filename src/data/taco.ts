...
export const TACO_FOODS: Food[] = [
  ...
  // === BEBIDAS ENERGÉTICAS ===
  { id: 'taco-red-bull', source: 'taco', category: 'Energéticos', name: 'Red Bull Energy Drink (lata 250ml)', proteinPer100g: 0, caloriesPer100g: 45, carbsPer100g: 11.0, fatPer100g: 0, servingGrams: 250 },
  { id: 'taco-red-bull-zero', source: 'taco', category: 'Energéticos', name: 'Red Bull Sugar Free (lata 250ml)', proteinPer100g: 0, caloriesPer100g: 3, carbsPer100g: 0, fatPer100g: 0, servingGrams: 250 },
  { id: 'taco-monster', source: 'taco', category: 'Energéticos', name: 'Monster Energy Original (lata 473ml)', proteinPer100g: 0, caloriesPer100g: 47, carbsPer100g: 11.6, fatPer100g: 0, servingGrams: 473 },
  { id: 'taco-monster-zero', source: 'taco', category: 'Energéticos', name: 'Monster Energy Zero Açúcar (lata 473ml)', proteinPer100g: 0, caloriesPer100g: 3, carbsPer100g: 0.6, fatPer100g: 0, servingGrams: 473 },
  { id: 'taco-tnt-energy', source: 'taco', category: 'Energéticos', name: 'TNT Energy Drink (lata 269ml)', proteinPer100g: 0, caloriesPer100g: 50, carbsPer100g: 12.5, fatPer100g: 0, servingGrams: 269 },
  { id: 'taco-fusion', source: 'taco', category: 'Energéticos', name: 'Fusion Energy (lata 250ml)', proteinPer100g: 0, caloriesPer100g: 48, carbsPer100g: 12.0, fatPer100g: 0, servingGrams: 250 },
  { id: 'taco-burn', source: 'taco', category: 'Energéticos', name: 'Burn Energy Drink (lata 260ml)', proteinPer100g: 0, caloriesPer100g: 50, carbsPer100g: 12.2, fatPer100g: 0, servingGrams: 260 },

  // === BEBIDAS PROTEICAS PRONTAS ===
  { id: 'sup-yopro-15', source: 'taco', category: 'Bebidas Proteicas', name: 'YoPro Bebida Láctea 15 g proteína (250ml)', proteinPer100g: 6.0, caloriesPer100g: 39, carbsPer100g: 2.8, fatPer100g: 0, servingGrams: 250 },
  { id: 'sup-yopro-25', source: 'taco', category: 'Bebidas Proteicas', name: 'YoPro Bebida Láctea 25 g proteína (250ml)', proteinPer100g: 10.0, caloriesPer100g: 60, carbsPer100g: 4.0, fatPer100g: 0.4, servingGrams: 250 },
  { id: 'sup-yopro-iogurte-15', source: 'taco', category: 'Bebidas Proteicas', name: 'YoPro Iogurte 15 g proteína (160g)', proteinPer100g: 9.4, caloriesPer100g: 60, carbsPer100g: 4.3, fatPer100g: 0.3, servingGrams: 160 },
  { id: 'sup-piracanjuba-whey', source: 'taco', category: 'Bebidas Proteicas', name: 'Piracanjuba Whey Shake (250ml)', proteinPer100g: 10.0, caloriesPer100g: 51, carbsPer100g: 1.8, fatPer100g: 0.3, servingGrams: 250 },
  { id: 'sup-piracanjuba-protein-25', source: 'taco', category: 'Bebidas Proteicas', name: 'Piracanjuba Protein 25 g (250ml)', proteinPer100g: 10.0, caloriesPer100g: 56, carbsPer100g: 3.0, fatPer100g: 0.4, servingGrams: 250 },
  { id: 'sup-itambe-nutrii', source: 'taco', category: 'Bebidas Proteicas', name: 'Itambé Nutrii Whey (200ml)', proteinPer100g: 7.5, caloriesPer100g: 60, carbsPer100g: 5.5, fatPer100g: 1.0, servingGrams: 200 },
  { id: 'sup-whey-shake-pronto', source: 'taco', category: 'Bebidas Proteicas', name: 'Whey shake pronto (genérico, 30g proteína)', proteinPer100g: 8.6, caloriesPer100g: 60, carbsPer100g: 3.5, fatPer100g: 1.2, servingGrams: 350 },
  { id: 'sup-leite-proteico', source: 'taco', category: 'Bebidas Proteicas', name: 'Leite proteico ultrafiltrado (200ml, ~18g prot)', proteinPer100g: 9.0, caloriesPer100g: 62, carbsPer100g: 3.0, fatPer100g: 1.5, servingGrams: 200 },

  // === COMIDA JAPONESA ===
  { id: 'jp-sushi-salmao', source: 'taco', category: 'Japonês', name: 'Sushi/niguiri de salmão (unidade ~25g)', proteinPer100g: 7.5, caloriesPer100g: 138, carbsPer100g: 21.0, fatPer100g: 2.4, servingGrams: 25 },
  { id: 'jp-sushi-atum', source: 'taco', category: 'Japonês', name: 'Sushi/niguiri de atum (unidade ~25g)', proteinPer100g: 8.5, caloriesPer100g: 130, carbsPer100g: 20.5, fatPer100g: 1.0, servingGrams: 25 },
  { id: 'jp-sushi-camarao', source: 'taco', category: 'Japonês', name: 'Sushi/niguiri de camarão (unidade ~25g)', proteinPer100g: 7.2, caloriesPer100g: 125, carbsPer100g: 21.0, fatPer100g: 0.8, servingGrams: 25 },
  { id: 'jp-sushi-kani', source: 'taco', category: 'Japonês', name: 'Sushi de kani (unidade ~25g)', proteinPer100g: 5.5, caloriesPer100g: 140, carbsPer100g: 24.0, fatPer100g: 1.5, servingGrams: 25 },
  { id: 'jp-uramaki-salmao', source: 'taco', category: 'Japonês', name: 'Uramaki/joe de salmão (1 peça ~22g)', proteinPer100g: 8.0, caloriesPer100g: 175, carbsPer100g: 22.0, fatPer100g: 5.5, servingGrams: 22 },
  { id: 'jp-hossomaki', source: 'taco', category: 'Japonês', name: 'Hossomaki de salmão (1 peça ~18g)', proteinPer100g: 6.5, caloriesPer100g: 130, carbsPer100g: 22.0, fatPer100g: 2.0, servingGrams: 18 },
  { id: 'jp-sashimi-salmao', source: 'taco', category: 'Japonês', name: 'Sashimi de salmão (5 fatias ~50g)', proteinPer100g: 22.5, caloriesPer100g: 208, carbsPer100g: 0, fatPer100g: 13.0, servingGrams: 50 },
  { id: 'jp-sashimi-atum', source: 'taco', category: 'Japonês', name: 'Sashimi de atum (5 fatias ~50g)', proteinPer100g: 25.0, caloriesPer100g: 130, carbsPer100g: 0, fatPer100g: 2.0, servingGrams: 50 },
  { id: 'jp-sashimi-peixe-branco', source: 'taco', category: 'Japonês', name: 'Sashimi de peixe branco (5 fatias ~50g)', proteinPer100g: 22.0, caloriesPer100g: 110, carbsPer100g: 0, fatPer100g: 1.5, servingGrams: 50 },
  { id: 'jp-temaki-salmao', source: 'taco', category: 'Japonês', name: 'Temaki de salmão (1 unidade ~140g)', proteinPer100g: 9.0, caloriesPer100g: 175, carbsPer100g: 22.0, fatPer100g: 5.5, servingGrams: 140 },
  { id: 'jp-temaki-atum', source: 'taco', category: 'Japonês', name: 'Temaki de atum (1 unidade ~140g)', proteinPer100g: 10.0, caloriesPer100g: 165, carbsPer100g: 22.0, fatPer100g: 3.5, servingGrams: 140 },
  { id: 'jp-temaki-philadelphia', source: 'taco', category: 'Japonês', name: 'Temaki Philadelphia (1 unidade ~140g)', proteinPer100g: 8.5, caloriesPer100g: 215, carbsPer100g: 21.5, fatPer100g: 9.0, servingGrams: 140 },
  { id: 'jp-hot-roll', source: 'taco', category: 'Japonês', name: 'Hot roll (1 peça ~35g, empanada)', proteinPer100g: 8.0, caloriesPer100g: 250, carbsPer100g: 26.0, fatPer100g: 12.0, servingGrams: 35 },
  { id: 'jp-hot-philadelphia', source: 'taco', category: 'Japonês', name: 'Hot philadelphia (1 peça ~35g)', proteinPer100g: 8.5, caloriesPer100g: 275, carbsPer100g: 25.5, fatPer100g: 14.0, servingGrams: 35 },
  { id: 'jp-yakisoba', source: 'taco', category: 'Japonês', name: 'Yakisoba de frango', proteinPer100g: 8.5, caloriesPer100g: 132, carbsPer100g: 17.0, fatPer100g: 3.5, servingGrams: 300 },
  { id: 'jp-yakimeshi', source: 'taco', category: 'Japonês', name: 'Yakimeshi (arroz frito japonês)', proteinPer100g: 5.5, caloriesPer100g: 165, carbsPer100g: 28.0, fatPer100g: 4.0, servingGrams: 200 },
  { id: 'jp-tempura-camarao', source: 'taco', category: 'Japonês', name: 'Tempurá de camarão (1 unidade ~30g)', proteinPer100g: 13.5, caloriesPer100g: 268, carbsPer100g: 19.0, fatPer100g: 14.0, servingGrams: 30 },
  { id: 'jp-tempura-legumes', source: 'taco', category: 'Japonês', name: 'Tempurá de legumes (3 unidades ~75g)', proteinPer100g: 4.5, caloriesPer100g: 240, carbsPer100g: 25.0, fatPer100g: 13.0, servingGrams: 75 },
  { id: 'jp-gyoza', source: 'taco', category: 'Japonês', name: 'Gyoza/guioza (5 unidades ~80g)', proteinPer100g: 7.5, caloriesPer100g: 215, carbsPer100g: 24.0, fatPer100g: 9.0, servingGrams: 80 },
  { id: 'jp-yakitori', source: 'taco', category: 'Japonês', name: 'Yakitori de frango (1 espeto ~70g)', proteinPer100g: 22.0, caloriesPer100g: 175, carbsPer100g: 4.0, fatPer100g: 8.0, servingGrams: 70 },
  { id: 'jp-edamame', source: 'taco', category: 'Japonês', name: 'Edamame cozido (vagem de soja)', proteinPer100g: 11.0, caloriesPer100g: 121, carbsPer100g: 9.9, fatPer100g: 5.2, servingGrams: 100 },
  { id: 'jp-missoshiru', source: 'taco', category: 'Japonês', name: 'Sopa de missô (missoshiru)', proteinPer100g: 2.2, caloriesPer100g: 40, carbsPer100g: 4.8, fatPer100g: 1.0, servingGrams: 200 },
  { id: 'jp-onigiri', source: 'taco', category: 'Japonês', name: 'Onigiri (bolinho de arroz com recheio)', proteinPer100g: 4.5, caloriesPer100g: 175, carbsPer100g: 36.0, fatPer100g: 1.0, servingGrams: 100 },
  { id: 'jp-katsu', source: 'taco', category: 'Japonês', name: 'Katsu de frango (frango empanado japonês)', proteinPer100g: 22.0, caloriesPer100g: 264, carbsPer100g: 11.0, fatPer100g: 13.5, servingGrams: 120 },
  { id: 'jp-ramen', source: 'taco', category: 'Japonês', name: 'Ramen (sopa com macarrão e carne)', proteinPer100g: 5.0, caloriesPer100g: 95, carbsPer100g: 12.0, fatPer100g: 3.0, servingGrams: 400 },
  { id: 'jp-poke-salmao', source: 'taco', category: 'Japonês', name: 'Poke bowl de salmão', proteinPer100g: 8.0, caloriesPer100g: 145, carbsPer100g: 17.0, fatPer100g: 5.0, servingGrams: 350 },
];
